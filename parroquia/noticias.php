...
<head>
    ...
    <title>Parroquia - Noticias</title>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li><a href="ver.php">Administrador</a>
						<!--<ul class="submenu">
							<li>
								<a href="ver.php">Vista1</a>
							</li>
							<li>
								<a href="ver.php">Vista2</a>
							</li>
							<li>
								<a href="ver.php">Vista3</a>
							</li>
						</ul>-->
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="box">
				<div class="col-lg-12">
				 ...
				 <form name="ingresarUsuario" action="conexion.php" method="post" enctype="application/x-www-form-urlencoded">
					<div class="col-md-12">
							<label for="titulo">Titulo de la Noticia:</label>
							<input type="text" size="40px" name="titulo" id="titulo" maxlength="30" required >  
							<br/>
							<br/>
							<label for="resumen">Resumen de la noticia:</label>
							<input type="text" size="120px" name="resumen" id="resumen" maxlength="132" required > 
							<br/>
							<br/>
						...
						<input class="btn btn-default btn-lg" type="submit", id="enviar", name="enviar", value="ENVIAR" />
					</div>
				</form>
