            ...
            <div class="box">
                ...
                <div class="col-md-12">
					<?php
						...
						$consulta="UPDATE noticias SET titulo='$titulo', resumen='$resumen', contenido='$editor1' WHERE id='$id' " ;
						$ejecutar=$con->query($consulta);
						
						if ($con->query($consulta) == TRUE) {
							echo '<script language="javascript"> alert("Se Edito la noticia");</script> ';
						}
						else {
							'<script language="javascript"> alert("NO se Edito la noticia");</script> ';
						}
