...
<head>
    ...
    <title>La Sagrada Eucaristía - Admin</title>
        ...
        <div class="row">
            <div class="box">
				<div class="col-lg-12">
					...
					<div class="col-md-12">
						<form action="validacion.php" method="post" align="center" >
									...
									<br><br>
									<input type="submit" class="btn btn-default btn-lg" name="Submit" value="LOGIN">
							</form>	
					</div>	
