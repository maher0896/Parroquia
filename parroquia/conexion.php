...
if (isset($_POST["titulo"])){
   ...
   echo '<script language="javascript"> alert("Ingresa a nuestro formulario de agregar noticia para continuar");</script> ';
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-12">
					...
					$consulta="INSERT INTO noticias(titulo, resumen, contenido)
						VALUES('$titulo', '$resumen','$contenido')";
					$ejecutar=$con->query($consulta);
					
					echo '<script language="javascript"> alert("Se inserto la noticia");</script> ';
